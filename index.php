    ...
    <section class="w3-row">
    	...
    	<div class="w3-third sale-center w3-padding">
    		<div class="sale-center">
    			<img class="w3-image" src="image/topsale/test3.jpg" alt="demo test">
    		</div><br/>
    		<div class="sale-center">
    			<img class="w3-image" src="image/topsale/test3.png" alt="demo test">
    		</div>
    	</div>
    </section>
    <section class="w3-row">
    	<div class="w3-twothird w3-padding">
    		<img class="w3-image" src="image/topsale/test4.jpg" alt="demo test">
    	</div>
    	<div class="w3-third w3-padding">
    		<img class="w3-image" src="image/topsale/test2.jpg" alt="demo test">
    	</div>
    </section>
    <main class="w3-row">
    	<section class="w3-twothird w3-padding">
    		<div class="w3-row">
    			<article class="w3-twothird sale-padding-min">
    				<img class="w3-image" src="image/topcontent/test1.jpg" alt="demotest" />
    			...
    			<article class="w3-third sale-padding-min">
    				<img class="w3-image" src="image/topcontent/test2.jpg" alt="demotest" />
